// PythonHardwareMonitor.cpp : Define o ponto de entrada para o aplicativo.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance, int nCmdShow)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PYTHONHARDWAREMONITOR));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_PYTHONHARDWAREMONITOR);
